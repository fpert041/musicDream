 ...
 *
 *  Edited by Pawel and Francesco - 2017
 *
 */
...
public:
	...
	ofSoundBufferPF();
	ofSoundBufferPF( const ofSoundBufferPF& other );
	ofSoundBufferPF( int nFrames, int nChannels );
	ofSoundBufferPF& operator=( const ofSoundBufferPF& other );
	
	~ofSoundBufferPF();
	void copyFrom( const ofSoundBufferPF& other );	
	/// Set audio data to 0.
	void clear();
